...
import { ParkingSession } from '../../../../../core/domain/entities/parking-session.entity';
import { SessionStatus } from '../../../../../core/domain/enums/session-status.enum';
import {
  CreateParkingSessionData,
  ParkingSessionRepositoryPort,
} from '../../../../../core/ports/out/parking-session.repository.port';
